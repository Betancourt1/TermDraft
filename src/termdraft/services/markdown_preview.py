...
FOOTNOTE_BACKREF_PREFIX = "#termdraft-footnote-back-"
FOOTNOTE_DEFINITION_PREFIX = "termdraft-footnote-"
FOOTNOTE_LABEL_TOKEN = "termdraft_footnote_label"
